...
public class WithArrayList2 {
    ...
    public static void main (String[] args) {
        ...
        studentList.add(new Student6("Sujit", 1));
        studentList.add(new Student6("Siddharth", 2));
        studentList.add(new Student6("Karanpreet", 3));

        studentList.add(new Student6("Tricha", 4));
